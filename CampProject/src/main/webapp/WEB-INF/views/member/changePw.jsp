		...
		<table class="table pw-table">
			<tr>
				...
				<td>
					...
					<input type="password" name="memberPw_old" id="memberPw_old"
					class="pw-input" placeholder="비밀번호를 입력해주세요"> <span id="text"></span>
				</td>
			</tr>
			<tr>
				<td>새 비밀번호</td>
				<td><input type="password" name="memberPw" id="memberPw"
					class="pw-input" placeholder="새로운 비밀번호를 입력해주세요"> <span id="text"></span>
				</td>
			</tr>
			<tr>
				<td>새 비밀번호 확인</td>
				<td><input type="password" name="memberPw_re" id="memberPw_re"
					class="pw-input" placeholder="비밀번호를 한번 더 입력해주세요"> <span id="text"></span>
				</td>
			</tr>
			<tr>
